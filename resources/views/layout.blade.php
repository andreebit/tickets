                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-5 col-lg-4 login-link-cntr">
                            ...
                            @else
                                <div>
                                    <a href="{{ route('user.autologin') }}" class="login-link btn btn-default col-xs-12 col-sm-6" >Registro</a>
                                    <a href="{{ route('user.autologin') }}" class="login-link btn btn-warning col-xs-12 col-sm-6">Iniciar Sesión</a>
                                </div>
                            @endif
                        </div>
                    </div>
